...
# PATHS
VCF_BY_POPULATION_PATH = DATA_FOLDER/VCF_BY_POPULATION_FOLDER
FREQ_BY_POPULATION_PATH = DATA_FOLDER/FREQ_BY_POPULATION_FOLDER
SNPS_DATA_PATH = DATA_FOLDER/SNPS_DATA_FOLDER
GENOTYPE_DATA_PATH = DATA_FOLDER/GENOTYPE_DATA_FOLDER
MERGED_VCF_OUTPUT_PATH = GENOTYPE_DATA_PATH/MERGED_VCF_FILE_NAME

# DOCKER IMAGES
IMAGE_WORKDIR = Path('/usr/src/app/')
IMAGE_SHARE_FOLDER_PATH = IMAGE_WORKDIR/'share_folder'
